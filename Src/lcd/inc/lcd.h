...
//SPI显示屏接口
//LCD_RST
#define SPILCD_RST_SET   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6, GPIO_PIN_SET)//PB0 
#define SPILCD_RST_RESET HAL_GPIO_WritePin(GPIOC, GPIO_PIN_6, GPIO_PIN_RESET)//PB0  
//LCD_RS//dc  
#define SPILCD_RS_SET  	 HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_SET)//PC4 
#define SPILCD_RS_RESET  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_RESET)//PC4  
//LCD_CS  
